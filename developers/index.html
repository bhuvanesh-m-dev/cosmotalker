...
<head>
    ...
    <meta property="og:url" content="https://yourwebsite.com"> <link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@400;700&family=Montserrat:wght@300;400;700&display=swap" rel="stylesheet">
...
<body class="bg-gray-950 text-gray-200">
    ...
    <div id="announcement-bar" class="announcement-bar">
        <span class="announcement-text">🏆 CosmoTalker won the Best Project Award at YASSC 2025!</span>
        <a href="https://bhuvaneshm.in/yassc25/" target="_blank" rel="noopener noreferrer" class="announcement-btn">More Details</a>
    </div>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <a href="https://bhuvaneshm.in/yassc25/" target="_blank" rel="noopener noreferrer" class="navbar-link" id="yassc-nav-link">YASSC</a>
        </div>
    </nav>
<br>
    <section id="hero-section" class="relative w-full text-center py-20 md:py-32 section-gradient-bg">
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div style="background-color: #0e0e10; padding: 40px; text-align: center; color: #fff; font-family: Arial, sans-serif; border-radius: 12px;">

  <h2 style="font-size: 2em; margin-bottom: 30px;">🚀 CosmoTalker in Action – Watch the Demo</h2>

  <div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; border-radius: 12px; box-shadow: 0 0 15px rgba(255,255,255,0.1);">
    <iframe 
      src="https://www.youtube.com/embed/71eGpymB1zE" 
      frameborder="0" 
  ...
  <div style="margin-top: 20px;">
    <a href="https://www.youtube.com/watch?v=71eGpymB1zE" target="_blank"
       style="color: #00bfff; font-size: 1.2em; text-decoration: none;">
        ▶️ Open on YouTube
    </a>
  </div>
    ...
    <section id="cosmic-footprint" class="py-16 md:py-24 section-gradient-bg scroll-fade-in">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 text-center">
                ...
                <!-- Aliyun Mirror -->
                <a href="https://mirrors.aliyun.com/pypi/simple/cosmotalker/" target="_blank" class="card-glow rounded-xl p-6 shadow-xl flex flex-col items-center justify-center hover:scale-105 transform transition-transform duration-300">
                    <i class="fas fa-cloud-download-alt text-6xl text-gray-400 mb-4"></i>
                    <h3 class="text-xl font-bold text-center">Aliyun Mirror for Cosmotalker</h3>
                </a>
                <!-- PyPIStats Page -->
                <a href="https://pypistats.org/packages/cosmotalker" target="_blank" class="card-glow rounded-xl p-6 shadow-xl flex flex-col items-center justify-center hover:scale-105 transform transition-transform duration-300">
                    <i class="fas fa-chart-line text-6xl text-gray-400 mb-4"></i>
                    <h3 class="text-xl font-bold text-center">PyPIStats for Cosmotalker</h3>
                </a>
                <!-- PyPIStats Mirror Image Stats API -->
                <a href="https://pypistats.org/api/packages/cosmotalker/overall?mirrors=true" target="_blank" class="card-glow rounded-xl p-6 shadow-xl flex flex-col items-center justify-center hover:scale-105 transform transition-transform duration-300">
                    <i class="fas fa-database text-6xl text-gray-400 mb-4"></i>
                    <h3 class="text-xl font-bold text-center">Mirror Stats API (JSON)</h3>
                </a>
            </div>
        </div>
    </section>
    ...
    <footer class="bg-gray-950 py-10 md:py-16 border-t border-cyan-800 section-gradient-bg">
        <div class="container mx-auto px-4 text-center">
            <div class="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-8 mb-8">
                ...
                <br><br>
                <!-- Badges with Referral Links -->

<a href="https://pypistats.org/packages/cosmotalker" target="_blank">
  <img src="https://img.shields.io/badge/downloads-50k-blue" alt="PyPI Downloads">
</a>

<a href="https://pypi.org/project/cosmotalker/" target="_blank">
  <img src="https://img.shields.io/pypi/v/cosmotalker.svg" alt="PyPI Version">
</a>

<a href="https://socket.dev/pypi/package/cosmotalker/overview" target="_blank">
  <img src="https://socket.dev/api/badge/pypi/package/cosmotalker/1.5.1?artifact_id=tar-gz" alt="Socket Badge">
</a>

<a href="https://github.com/bhuvanesh-m-dev/cosmotalker/blob/main/document/LICENSE" target="_blank">
  <img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="License">
</a>

<a href="https://github.com/bhuvanesh-m-dev/cosmotalker/commits/main" target="_blank">
  <img src="https://img.shields.io/github/last-commit/bhuvanesh-m-dev/cosmotalker" alt="Last Commit">
</a>

<a href="https://github.com/bhuvanesh-m-dev/cosmotalker/issues" target="_blank">
  <img src="https://img.shields.io/github/issues/bhuvanesh-m-dev/cosmotalker" alt="Issues">
</a>

<a href="https://github.com/bhuvanesh-m-dev/cosmotalker/stargazers" target="_blank">
  <img src="https://img.shields.io/github/stars/bhuvanesh-m-dev/cosmotalker" alt="GitHub Stars">
</a>
...
<a href="https://www.python.org/" target="_blank">
  <img src="https://img.shields.io/badge/Made%20with-Python-blue?logo=python" alt="Made with Python">
    ...
    CosmoTalker's age is : <span id="cosmotalker-age"></span>
</p>
            <p class="text-gray-500 text-sm">© 2025 Cosmotalker. All rights reserved.</p>
        </div>
    </footer>
    ...
    <script>
    // Define the start date and time (March 2, 2025, 11:10:00 AM)
    // This will be interpreted in the client's local timezone.
    const startDate = new Date('2025-03-02T11:10:00'); 

    function updateCosmoTalkerAge() {
        const now = new Date();
        const diff = now.getTime() - startDate.getTime(); // Difference in milliseconds

        if (diff < 0) {
            document.getElementById('cosmotalker-age').textContent = "Not yet born!";
            return;
        }
        ...
        document.getElementById('cosmotalker-age').textContent =
            `${days} days, ${hours} hours, ${minutes} minutes, ${seconds} seconds, ${String(milliseconds).padStart(3, '0')} milliseconds`;
    }

    // Update the age immediately and then every 10 milliseconds for smooth display
    updateCosmoTalkerAge();
    setInterval(updateCosmoTalkerAge, 10);
</script>
</body>
</html>
